...
#define SN32_RGB_MATRIX_ROWS 8
#define SN32_RGB_MATRIX_ROW_CHANNELS 3
#define SN32_RGB_MATRIX_ROWS_HW (SN32_RGB_MATRIX_ROWS * SN32_RGB_MATRIX_ROW_CHANNELS)

#define SN32_RGB_MATRIX_ROW_PINS { C0, C1, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, B6, B7, B8, B9, B10, B11, D4, B15, D3 , D5, A15, D6  }

#define SN32_RGB_MATRIX_COLS 21
